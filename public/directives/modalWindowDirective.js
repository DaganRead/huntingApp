app.directive("modalWindow", function($compile, $timeout, $location) {
  return {
    ...
    template: '<modalWindow class="md-modal md-effect" id="modal"><div class="md-content"><md-close ng-click="modalWindowClose()"></md-close><md-title></md-title><md-view></md-view><md-footer ng-click="modalWindowFooter()"></md-footer></div></modalWindow>',
    replace: true,
    scope: {
